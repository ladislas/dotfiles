...
try defaults write NSGlobalDomain NSWindowResizeTime -float 0.001
...
# try /System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister -kill -r -domain local -domain system -domain user

# Display ASCII control characters using caret notation in standard text views
# Try e.g. `cd /tmp; unidecode "\x{0000}" > cc.txt; open -e cc.txt`
try defaults write NSGlobalDomain NSTextShowsControlCharacters -bool true
...
try defaults write NSGlobalDomain com.apple.swipescrolldirection -bool true
...
try defaults write NSGlobalDomain AppleLanguages -array "en" "fr"
try defaults write NSGlobalDomain AppleLocale -string "en_US@currency=EUR"
try defaults write NSGlobalDomain AppleMeasurementUnits -string "Centimeters"
try defaults write NSGlobalDomain AppleMetricUnits -bool true
...
try sudo pmset -a autorestart 1

# Restart automatically if the computer freezes
try sudo systemsetup -setrestartfreeze on
...
try defaults write com.apple.finder NewWindowTarget -string "PfDe"
try defaults write com.apple.finder NewWindowTargetPath -string "file://${HOME}/Desktop/"
...
try defaults write com.apple.frameworks.diskimages auto-open-ro-root -bool true
try defaults write com.apple.frameworks.diskimages auto-open-rw-root -bool true
try defaults write com.apple.finder OpenWindowForNewRemovableDisk -bool true
...
try defaults write com.apple.finder FXPreferredViewStyle -string "clmv"

# Disable the warning before emptying the Trash
# defaults write com.apple.finder WarnOnEmptyTrash -bool false

# Enable AirDrop over Ethernet and on unsupported Macs running Lion
try defaults write com.apple.NetworkBrowser BrowseAllInterfaces -bool true
...
try defaults write com.apple.finder FXInfoPanesExpanded -dict \
	General -bool true \
	OpenWith -bool true \
...
# Available options: "left" "right" or "bottom"
...
try defaults write com.apple.dock expose-animation-duration -float 0.1
...
try defaults write com.apple.dock showhidden -bool true
...
try defaults write com.apple.dock wvous-bl-corner -int 11
...
try defaults write com.apple.ActivityMonitor IconType -int 5
...
try defaults write com.apple.addressbook ABShowDebugMenu -bool true
...
try defaults write com.apple.appstore WebKitDeveloperExtras -bool true

# Enable Debug Menu in the Mac App Store
try defaults write com.apple.appstore ShowDebugMenu -bool true
...
try defaults write com.apple.SoftwareUpdate ConfigDataInstall -int 1
...
try defaults write com.google.Chrome AppleEnableSwipeNavigateWithScrolls -bool false
try defaults write com.google.Chrome.canary AppleEnableSwipeNavigateWithScrolls -bool false

# Disable the all too sensitive backswipe on Magic Mouse
try defaults write com.google.Chrome AppleEnableMouseSwipeNavigateWithScrolls -bool false
try defaults write com.google.Chrome.canary AppleEnableMouseSwipeNavigateWithScrolls -bool false

# Use the system-native print preview dialog
try defaults write com.google.Chrome DisablePrintPreview -bool true
try defaults write com.google.Chrome.canary DisablePrintPreview -bool true

# Expand the print dialog by default
try defaults write com.google.Chrome PMPrintingExpandedStateForPrint2 -bool true
try defaults write com.google.Chrome.canary PMPrintingExpandedStateForPrint2 -bool true
